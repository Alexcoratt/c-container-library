...
DynamicArray_demo: DynamicArray_default default_functions_impl
	...
	${CC} ${CFLAGS} -c -include include/type_definitions.h -DDYNAMIC_ARRAY_VALUE_TYPE=string -o ${BUILD_DIR}/DynamicArray_string_object.o ${SOURCE_DIR}/DynamicArray_object.c
	${CC} ${CFLAGS} -o ${BUILD_DIR}/DynamicArray_demo ${SOURCE_DIR}/DynamicArray_demo.c ${BUILD_DIR}/DynamicArray_string.o ${BUILD_DIR}/DynamicArray_int.o ${BUILD_DIR}/DynamicArray_default.o ${BUILD_DIR}/default_functions_impl.o ${BUILD_DIR}/DynamicArray_string_object.o -lm
